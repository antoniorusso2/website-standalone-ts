        ...
        <div className="container">
            <div className="content_section text-center text-balance">
                ...
                <p className="description my-5">
                    ...
                    quinte” mi hanno spinto a voler creare e costruire in prima persona. Ho studiato
                    principalmente da autodidatta sia basi di networking che cybersecurity ed ho poi
                    scelto di intraprendere un percorso più serio e mirato verso lo sviluppo web. Mi
                    piace dare forma alle idee con grande attenzione ai dettagli e spirito pratico,
                    affrontando ogni sfida con entusiasmo, crescita continua e voglia di mettermi in
                    gioco.
                </p>
            </div>
        </div>
